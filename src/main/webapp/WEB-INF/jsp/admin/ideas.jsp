...
<head>
  <title>Idea Listing!</title>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/public/js/admin/ideas.js"></script>
...
<body>
  ...
  <div id="internal-pg-content">
    ...
    <c:set var="ideas" value="${viewStatus.data['ideas']}"/>
	  <div id='ideaData'>
  		</div>
