...
<head>
  <title>Project Listing!</title>
    ...
    <script type="text/javascript" src="<%=request.getContextPath()%>/public/js/admin/users.js"></script>
...
<body>
  <div id="ie-adm-tab-menu">
        ...
        <div class="ie-adm-tabmenu-spacer"> &nbsp;</div>
        <div><a class="ie-adm-tabmenu-items-selected" href="<%=request.getContextPath()%>/admin/users"> Users</a></div>  
        <div class="ie-adm-tabmenu-spacer"> &nbsp; </div>
  ...
  <div id="internal-pg-content">
    ...
    <c:set var="users" value="${viewStatus.data['users']}"/>
	  <div id='userData'>
  		</div>
