...
<div>
  <label><input type="hidden" name="email" value="yes" />AX Request email</label>
</div>
<div>
  <label><input type="hidden" name="country" value="yes" />AX Request home country</label>
</div>
<div>
  <label><input type="hidden" name="language" value="yes" />AX Request preferred language</label>
</div>
<div>
  <label><input type="hidden" name="firstName" value="yes" />AX Request first name</label>
</div>
<div>
  <label><input type="hidden" name="lastName" value="yes" />AX Request last name</label>
</div><hr />
<div>
  <label><input type="hidden" name="usePost" value="yes" />Use POST instead of GET</label>
</div>
<div>
